...
$(document).ready(function () {
    $("#delivery").submit(function (event) {
        ...
        alert("Hello " + name + ". Your order has been successfuly received and will be delivered to " +  location + " within one hour.The delivery will cost ksh 180/= Thank you for choosing darollesyyj dccccccccc  pizzeria palace.");
        // $(this).get(0).reset();
         event.preventDefault();
    });
